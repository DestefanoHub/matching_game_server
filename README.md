...
`npm run test` will run the entire test suite, automatically handling a local server when necessary, and handle an in-memory MongoDB instance as the test database.
